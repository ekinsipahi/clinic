"""
Django settings for devrim_website project.
...
SECRET_KEY = "django-insecure-v_en1)dpldps(40^)u)bxz#wridwl#@=9kqrq+9amu&4(5x@5^"
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # 🔥 bu satır eklenecek
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.pepjtuncgggbcwacefdg',
